export const UserSafetyResources = () => (
  <div className="space-y-4">
    <section className="rounded-xl border border-[var(--color-brand-border)] bg-[var(--color-brand-dark)] p-5">
      <h2 className="text-2xl font-semibold text-[var(--color-brand-text)]">Safety Resources</h2>
    ...
    <section className="grid gap-3 md:grid-cols-2">
      <article className="rounded-xl border border-[var(--color-brand-border)] bg-[var(--color-brand-dark)] p-4">
        <h3 className="text-sm font-semibold text-[var(--color-brand-text)]">Emergency Checklist</h3>
        <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-[var(--color-brand-muted)]">
      ...
      <article className="rounded-xl border border-[var(--color-brand-border)] bg-[var(--color-brand-dark)] p-4">
        <h3 className="text-sm font-semibold text-[var(--color-brand-text)]">Emergency Contacts</h3>
        <ul className="mt-2 space-y-1 text-sm text-[var(--color-brand-muted)]">
